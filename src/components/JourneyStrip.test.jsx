...
describe('JourneyStrip', () => {
  it('shows progress through three rounds toward the gift', () => {
    ...
    expect(container.querySelectorAll('.journey-strip__star')).toHaveLength(3);
    expect(container.querySelectorAll('.journey-strip__star--filled')).toHaveLength(2);
  ...
  it('lights every star and opens the gift after a super round', () => {
    ...
    expect(container.querySelectorAll('.journey-strip__star--filled')).toHaveLength(3);
