const messages = Object.freeze({
  ...
  keyboardSystem: 'Nincs betűbillentyű',
  keyboardFull: 'Minden betű',
  keyboardSimple: 'Néhány betű',
  keyboardHelp: 'Nagy nyomtatott betűbillentyűk a szó alatt. Az eszköz billentyűzete mindkét esetben működik.',
  ...
  autoLadder: 'Rövid szavakkal kezdjen, majd jöjjenek hosszabbak',
  autoLadderHelp: 'A Project Spell rövidebb szavakkal kezd, és a megtanult szavak után fokozatosan hosszabbakat ad.',
  ...
  packAnimals: 'Állatok',
  packFood: 'Ételek',
  packVehicles: 'Járművek',
  packNature: 'Természet',
  noWordsMatch: 'Ezekkel a beállításokkal nincs megfelelő szó',
  allWordsMastered: 'Minden megfelelő szót megtanult — nagyszerű! Adj hozzá több szót, vagy emeld a szűrőket.',
  ...
  masteredCountLine: '{count} megtanult szó',
