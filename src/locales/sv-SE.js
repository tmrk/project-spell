const messages = Object.freeze({
  ...
  keyboardSystem: 'Inga tangenter',
  keyboardFull: 'Alla bokstäver',
  keyboardSimple: 'Några bokstäver',
  keyboardHelp: 'Stora versala bokstavstangenter under ordet. Enhetens tangentbord fungerar ändå.',
  ...
  autoLadder: 'Börja kort och gå vidare till längre ord',
  autoLadderHelp: 'Project Spell börjar med kortare ord och låser varsamt upp längre när ord bemästras.',
  ...
  allWordsMastered: 'Alla matchande ord är bemästrade — fantastiskt! Lägg till fler ord eller höj filtren.',
  ...
  masteredCountLine: '{count} bemästrade ord',
